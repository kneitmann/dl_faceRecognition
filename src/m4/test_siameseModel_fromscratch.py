...
from loadData import createDataset, generate_image_pairs, load_img, get_label

from create_siameseModel import createSiameseModel_fromScratch, contrastive_loss_with_margin, triplet_loss, CNN
...
if as_triplet:
    model = CNN((image_height, image_width, 3))
    ...
    model = createSiameseModel_fromScratch(
