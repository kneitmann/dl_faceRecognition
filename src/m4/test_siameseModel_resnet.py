...
from create_siameseModel import createSiameseModel_resnet, contrastive_loss_with_margin, triplet_loss, ResNet_WithTop
from test_functions import *

# ------------------------------- PARAMETERS ------------------------------- #

model_name = 'siamese_model_resnet'
...
if as_triplet:
    ...
    model = createSiameseModel_resnet(
                (image_height, image_width, 3), 
                0.3,
                False,
                weighted,
